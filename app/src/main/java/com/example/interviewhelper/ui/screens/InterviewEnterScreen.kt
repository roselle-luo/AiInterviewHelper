...
import com.example.interviewhelper.viewmodel.InterviewEnterScreenViewModel

@Composable
fun Interview(navController: NavController, viewModel: InterviewEnterScreenViewModel = hiltViewModel()) {
